...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.onALSlideChange = function (evt) {
        ...
        if (this.AL_CurrSlide == 1) {
            ...
            if (this.AL_FilteredList.length != 0 && this.AL_FilteredList.filter(function (data) { return data.isin === _this.selComp.isin; }).length != 0)
                this.scrollto();
            else
    ...
    HomePage.prototype.scrollToListTop = function () {
        // var index = this.selIndexData.indexOf(this.selComp);
        var list = document.getElementById('CompList');
        list.scrollTop = 0;
    };
