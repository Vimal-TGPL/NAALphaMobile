...
var PerformancePageRoutingModule = /** @class */ (function () {
    function PerformancePageRoutingModule() {
    }
...
var PerformancePage = /** @class */ (function () {
    ...
    PerformancePage.prototype.ngAfterViewInit = function () {
        if (this.mobile) {
    ...
    PerformancePage.prototype.OnCardScroll = function (e) {
        var ref = document.getElementById('IndexListCard');
        if (ref.scrollTop > 200) {
            ref.classList.add("bottomCardScrollUp");
        }
    };
    PerformancePage.prototype.loadData = function () {
        var _this = this;
        if (this.key == 'ESG') {
            this.dataHandler.getPerfData().subscribe(function (res) {
                //    console.log(res);
                _this.PerformanceData = res;
                _this.dataHandler.getEsgPerfData().subscribe(function (res) {
                    //    console.log(res);
                    var temp = [];
                    temp = res;
                    temp = temp.filter(function (data) { return data.indexId != 108 && data.indexId != 113 && data.indexId != 69; });
                    //    console.log(temp);
            ...
            this.dataHandler.getPerfData().subscribe(function (res) {
                //    console.log(res);
                _this.PerformanceData = res;
                _this.dataHandler.getFIPerfData().subscribe(function (res) {
                    //    console.log(res);
                    var temp = [];
                    temp = res;
            ...
            this.dataHandler.getPerfData().subscribe(function (res) {
                //    console.log(res);
                _this.PerformanceData = res;
                _this.dataHandler.getEquityPerfIndData().subscribe(function (res) {
                    //    console.log(res);
                    var temp = [];
                    temp = res;
                    var LeadingIndex = temp.filter(function (rec) { return rec.indexName.indexOf('Leading') != -1; });
                    //  console.log(LeadingIndex);
                    _this.IndexData = LeadingIndex;
                    _this.CheckCountry();
                    _this.OnItemClick(_this.CountryClasificationList[0]);
                });
            });
            ...
            this.dataHandler.getPerfData().subscribe(function (res) {
                ...
                _this.dataHandler.getEquityPerfIndData().subscribe(function (res) {
                    ...
                    var temp = [];
                    temp = res;
                    var LongShortIndex = temp.filter(function (rec) { return (rec.indexName.indexOf('Long') != -1 || rec.indexName.indexOf('Short') != -1) && rec.indexName.indexOf('Long-Short') == -1; });
                    //  console.log(LongShortIndex);
                    _this.IndexData = LongShortIndex;
                    _this.CheckCountry();
                    _this.OnItemClick(_this.CountryClasificationList[0]);
                });
            });
            ...
            this.dataHandler.getPerfData().subscribe(function (res) {
                ...
                _this.dataHandler.getEquityPerfIndData().subscribe(function (res) {
                    ...
                    var temp = [];
                    temp = res;
                    var LowVolIndex = temp.filter(function (rec) { return rec.indexName.indexOf('Low Volatility') != -1; });
                    //   console.log(LowVolIndex);
                    _this.IndexData = LowVolIndex;
                    _this.CheckCountry();
                    _this.OnItemClick(_this.CountryClasificationList[0]);
                });
            });
            ...
            this.dataHandler.getEquityPerfIndData().subscribe(function (res) {
                var temp = [];
                temp = res;
                temp = temp.filter(function (data) { return data.indexId == 107 || data.indexId == 104 || data.indexId == 13 || data.indexId == 1 || data.indexId == 12 || data.indexId == 54; });
                _this.IndexData = temp;
                _this.dataHandler.getEsgPerfData().subscribe(function (res) {
                    var temp = [];
                    temp = res;
                    temp.filter(function (data) {
                        if (data.indexId == 69 || data.indexId == 108 || data.indexId == 113) {
                            _this.IndexData.push(data);
                        }
                    });
                    //   console.log(this.IndexData);
                    _this.CheckCountry();
                    _this.onConstChipClick();
                    _this.OnItemClick(_this.CountryClasificationList[0]);
                    _this.showMVCons = true;
                });
            });
        }
    ...
    PerformancePage.prototype.CheckCountry = function () {
        var temp = [];
        if (this.IndexData.length != 0) {
            if (this.IndexData.filter(function (data) { return data.indexName.indexOf('U.S') != -1 || data.indexName.indexOf('USD') != -1; }).length != 0) {
                temp.push("USA");
            }
            if (this.IndexData.filter(function (data) { return data.indexName.indexOf('Ex-UK') != -1; }).length != 0) {
                temp.push("Europe");
            }
            if (this.IndexData.filter(function (data) { return (data.indexName.indexOf('United Kingdom') != -1 || data.indexName.indexOf('UK') != -1) && data.indexName.indexOf('Ex-UK') == -1; }).length != 0) {
                temp.push("UK");
            }
            if (this.IndexData.filter(function (data) { return data.indexName.indexOf('Japan') != -1; }).length != 0) {
                temp.push("Japan");
            }
            if (this.IndexData.filter(function (data) { return data.indexName.indexOf('Developed World') != -1; }).length != 0) {
                temp.push("Dev. World");
            }
    ...
    PerformancePage.prototype.OnItemClick = function (item) {
        //  console.log(item);
        this.selectedCountry = item;
        this.selectedOption = null;
        //  console.log(this.IndexData);
        if (item == 'USA') {
            this.SelCountryData = this.IndexData.filter(function (data) { return data.indexName.indexOf('U.S') != -1 || data.indexName.indexOf('USD') != -1; });
        }
        else if (item == 'Japan') {
            this.SelCountryData = this.IndexData.filter(function (data) { return data.indexName.indexOf('Japan') != -1; });
        }
        else if (item == 'Europe') {
            this.SelCountryData = this.IndexData.filter(function (data) { return data.indexName.indexOf('Ex-UK') != -1; });
        }
        else if (item == 'Dev. World') {
            this.SelCountryData = this.IndexData.filter(function (data) { return data.indexName.indexOf('Developed World') != -1; });
        }
        else if (item == 'UK') {
            this.SelCountryData = this.IndexData.filter(function (data) { return (data.indexName.indexOf('United Kingdom') != -1 || data.indexName.indexOf('UK') != -1) && data.indexName.indexOf('Ex-UK') == -1; });
        }
    ...
    PerformancePage.prototype.onIndexItemClick = function () {
        document.getElementById('BottomCardDiv').style.display = "none";
        document.getElementById('BottomCardDiv').style.transition = ".2s";
    };
    PerformancePage.prototype.replaceId = function (item) {
        var itm = item.replace(/ /g, '-');
        return itm;
    };
    PerformancePage.prototype.replaceIdCard = function (item) {
        var itm = item.replace(/ /g, '-');
        return itm + 'Card';
    };
    PerformancePage.prototype.onIndexChange = function (event) {
        var _this = this;
        ...
        var inddata = this.PerformanceData.filter(function (data) { return data.indexName == _this.selectedIndex.indexName; });
        this.selectedIndexData = inddata[0];
        // console.log(this.selectedIndexData);
        // console.log(event.target.value);
        var d = this.IndexData.filter(function (data) { return data.indexName.indexOf(event.target.value) != -1; });
    ...
    PerformancePage.prototype.onOptionsSelected = function (indId) {
        if (this.key != 'Market View') {
            this.selectedIndex = this.SelCountryData.filter(function (data) { return data.indexId == indId; })[0];
            //  console.log(this.selectedIndex);
            this.selectedIndexData = this.PerformanceData.filter(function (data) { return data.indexId == indId; })[0];
            // console.log(this.selectedIndexData);
            ...
            this.selectedIndex = this.SelCountryData.filter(function (data) { return data.indexId == indId; })[0];
            //  console.log(this.selectedIndex);
            this.selectedIndexData = this.SelCountryData.filter(function (data) { return data.indexId == indId; })[0];
            this.selectedIndexName = this.selectedIndexData.indexName;
            // console.log(this.selectedIndexData);
            // this.getBMData();
    ...
    PerformancePage.prototype.getBMData = function () {
        var _this = this;
        var temp = this.PerformanceData.filter(function (x) { return x.indexId == _this.selectedIndexData.benchMarkId && x.relatedIndexId == _this.selectedIndexData.indexId; });
        if (temp.length != 0) {
    ...
    PerformancePage.prototype.getEquityList = function () {
        var filterStr = 'U.S.';
        var tempEq = this.IndexData.filter(function (data) { return data.indexName.indexOf(filterStr) != -1; });
        tempEq = tempEq.sort(function (a, b) {
            return a.sortOrder - b.sortOrder;
        });
        this.EquityList = tempEq;
    };
    PerformancePage.prototype.onPerfChipClick = function () {
        this.selectedSection = 'perfomance';
    };
    PerformancePage.prototype.onConstChipClick = function () {
        this.selectedSection = 'construction';
    };
    PerformancePage.prototype.onimgClick = function (img, title) {
        this.photoViewer.show(this.file.applicationDirectory + img, title, { share: false });
    };
    PerformancePage.prototype.onYearClick = function () {
                        ...
                        opts = {
                            buttons: [{
                                    ...
                                    handler: function (val) {
                                        _this.selectedYear = val.Year.text;
                                        //      console.log(this.selectedYear);
                                        _this.getYearData();
                                        _this.selectedDate = _this.dateList[0].rebalanceDt;
                                        _this.fetchSignal(_this.selectedDate);
                                    }
                                }],
                            columns: [{
                                    name: 'Year',
    ...
    PerformancePage.prototype.getselectedYear = function () {
        var _this = this;
        //  console.log(''+this.selectedYear);
        if (this.selectedYear) {
            // console.log(this.yearList);
            var temp = this.yearList.filter(function (i) { return i == _this.selectedYear; })[0];
            //  console.log(temp);
    ...
    PerformancePage.prototype.getYearData = function () {
        var yearIndex = this.yearList.indexOf(this.selectedYear);
        //  console.log(yearIndex);
        this.dateList = this.rebalance_dates[yearIndex].values;
        //  console.log(this.dateList);
    };
    PerformancePage.prototype.getYearColumnOptions = function () {
        var that = this;
        if (this.rebalance_dates.length != 0) {
            var tempdates = this.rebalance_dates.slice();
            // that.yearList.length = 0;
            that.yearList = tempdates.map(function (i) { return i.key; });
            //  console.log(this.yearList);
            var temp = [];
    ...
    PerformancePage.prototype.openPicker = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var opts, picker;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        ...
                        opts = {
                            buttons: [{
                                    ...
                                    handler: function (val) {
                                        ...
                                        _this.selectedIndexName = temp;
                                        _this.onOptionsSelected(_this.getSelectedDataId(temp));
                                        _this.getColumnOptions();
                                    }
                                }
                            ],
                            cssClass: 'picOptions',
    ...
    PerformancePage.prototype.getSelectedDataId = function (val) {
        // console.log(val);
        var temp = this.SelCountryData.filter(function (data) { return data.indexName.replace('New Age Alpha ', '').replace('Total Return ', '') == val; })[0];
        //  console.log(temp);
        return temp.indexId;
    };
    PerformancePage.prototype.getSelectedIndex = function () {
        var _this = this;
        if (this.selectedOption) {
            var temp = this.OptionsList.filter(function (i) { return i.text == _this.selectedOption.Index.text; });
    ...
    PerformancePage.prototype.getColumnOptions = function () {
        var _this = this;
        ...
        this.SelCountryData.forEach(function (element) {
            ...
            _this.OptionsList.push({ text: temp, value: temp });
        });
        return this.OptionsList;
    };
    PerformancePage.prototype.onCancelClick = function () {
        setTimeout(function () {
    ...
    PerformancePage.prototype.onDescCloseClick = function () {
        this.descModel = false;
    };
    PerformancePage.prototype.oncardClick = function (val) {
        // console.log(val);
        this.selectedCard = val;
    };
    PerformancePage.prototype.roundValue = function (val) {
        var v = Math.round(val * 100) / 100;
        return v.toFixed(2);
    };
    PerformancePage.prototype.createChart = function () {
        var _this = this;
        var that = this;
        this.dataHandler.getRebalanceDates(this.selectedIndexData.indexId).then(function (data) {
            ...
            if (data.length > 0) {
                ...
                that.rebalance_dates = d3__WEBPACK_IMPORTED_MODULE_8__["nest"]()
                    .key(function (d) { return d.rebalanceDt.substring(0, 4); })
                    .entries(data).sort(function (x, y) { d3__WEBPACK_IMPORTED_MODULE_8__["descending"](x.key, y.key); });
                //   console.log(that.rebalance_dates);
                _this.selectedYear = that.rebalance_dates[0].key;
                //   console.log(this.selectedYear);
                _this.getYearColumnOptions();
                _this.getYearData();
                that.selectedDate = _this.rebalance_dates[0].values[0].rebalanceDt;
                that.isUnscheduled = _this.rebalance_dates[0].values[0].unscheduled;
                //  console.log(this.selectedDate);
                //   console.log(this.isUnscheduled);
                that.fetchSignal(that.selectedDate);
                _this.SelRelIndexPart = _this.RelIndexPart.filter(function (data) { return data.id == _this.selectedIndexData.indexId; })[0];
                // console.log
    ...
    PerformancePage.prototype.fetchSignal = function (tradedate) {
        var _this = this;
        // console.log(tradedate);
        var that = this;
        this.dataHandler.getSignalsByDate(this.selectedIndexData.indexId, tradedate).then(function (signaldata) {
            //    console.log(signaldata);
            if (_this.selectedIndexData.indexId == 54) {
                if (signaldata.length > 0) {
                    var USLC = signaldata.filter(function (x) { return x.indexCode == 9; })[0];
                    var USSC = signaldata.filter(function (x) { return x.indexCode == 4; })[0];
                    var Euro = signaldata.filter(function (x) { return x.indexCode == 13; })[0];
                    var Uk = signaldata.filter(function (x) { return x.indexCode == 1; })[0];
                    var Jap = signaldata.filter(function (x) { return x.indexCode == 12; })[0];
                    if (USLC != undefined) {
                        if (USLC.urltt == 1) {
                            that.sLC = 1;
                        }
                    ...
                    // that.EnableGroup();
                    _this.dataHandler.GetGlobalSignalsByDate(_this.selectedIndexData.indexId, tradedate).then(function (globalsignaldata) {
    ...
    PerformancePage.prototype.getDate = function (rebalanceDT) {
        var tempdt = rebalanceDT.slice(0, 4) + "/" + rebalanceDT.slice(4, 6) + '/' + rebalanceDT.slice(6, 8);
        var temp = new Date(tempdt);
        return temp.getDate();
    };
    PerformancePage.prototype.getMonth = function (rebalanceDT) {
        var tempdt = rebalanceDT.slice(0, 4) + "/" + rebalanceDT.slice(4, 6) + '/' + rebalanceDT.slice(6, 8);
        var temp = new Date(tempdt);
        return temp.toLocaleString('default', { month: 'short' });
    };
    PerformancePage.prototype.onDateClick = function (rebalancedt) {
        var _this = this;
        // console.log('dateclick');
        this.ShowAll = false;
        this.selectedDate = rebalancedt;
        this.isUnscheduled = this.rebalance_dates.filter(function (data) { return data.key == _this.selectedYear; })[0].values.filter(function (da) { return da.rebalanceDt == _this.selectedDate; })[0].unscheduled;
        // console.log(this.isUnscheduled);
        this.fetchSignal(rebalancedt);
    };
    PerformancePage.prototype.indexNameReplace = function (item) {
        var temp = item.replace('New Age Alpha ', '');
        temp = temp.replace('Total Return ', '');
        return temp;
    };
    PerformancePage.prototype.getTitle = function () {
        if (this.key == 'ESG') {
    ...
    PerformancePage.prototype.onSvgClick = function (id) {
        var _this = this;
        this.pngLoader = true;
        var width = 0;
        var height = 0;
        ...
        save_svg_as_png__WEBPACK_IMPORTED_MODULE_11__["svgAsPngUri"](document.getElementById(id), options, function (uri) {
            // console.log(uri);
            _this.photoViewer.show(uri, _this.selectedIndex.indexCode, { share: false });
            _this.pngLoader = false;
        });
    };
    PerformancePage.prototype.EnableGroup = function () {
    ...
    PerformancePage.prototype.wrap = function (text, width, xval) {
        text.each(function () {
    ...
    PerformancePage.prototype.Rbdisplaydate = function (val) {
        if (val != undefined) {
