...
var LandingPage = /** @class */ (function () {
    function LandingPage(authService, alertCtrl, network, platform, iab, route) {
    ...
    LandingPage.prototype.onSkipClick = function () {
        this.iab.create(this.url, '_blank', 'location=no,toolbar=yes,zoom=no');
    };
    LandingPage.prototype.onLoginClick = function () {
        this.route.navigateByUrl('/auth');
    };
    LandingPage.prototype.onForgotPwdClick = function () {
        this.route.navigateByUrl('/forgot-password');
    };
    LandingPage.prototype.onSignupClick = function () {
